    ...
    <nav class="container-fluid navbar navbar-expand-lg sticky-top mt-3 ">
        <div class="container">
          ...
          <div class="offcanvas offcanvas-end w-75" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
            ...
            <?php if ($_SESSION['user_type'] == 'doctor'): ?>
            <a style="display: none;" class="btn btn-reserve fw-medium" href="reservation.html" role="button" data-bs-toggle="modal" data-bs-target="#reservationform-modal">RESERVE NOW</a>
            <?php else: ?>
              ...
              <div class="container mx-auto p-5">
                <div class="row">
                  ...
                  <div class="col-md-2 col-sm-6 col-lg-2 col-xl-2 mx-auto mt-3 link-footer">
                    ...
                    <p>
                      <a data-bs-toggle="modal" data-bs-target="#reservationform-modal" class="link" style="text-decoration: none;">Dental Filling</a>
                    </p>
                    <p>
                      <a data-bs-toggle="modal" data-bs-target="#reservationform-modal" class="link" style="text-decoration: none;">Teeth Whitening</a>
                    </p>
                    <p>
                      <a data-bs-toggle="modal" data-bs-target="#reservationform-modal" class="link" style="text-decoration: none;">Orthodontic Braces</a>
                    </p>
                    <p>
                      <a data-bs-toggle="modal" data-bs-target="#reservationform-modal" class="link" style="text-decoration: none;">Dentures</a>
                    </p>
                    <p>
                      <a data-bs-toggle="modal" data-bs-target="#reservationform-modal" class="link" style="text-decoration: none;">Dental Care</a>
                    </p>
                    <p>
                      <a data-bs-toggle="modal" data-bs-target="#reservationform-modal" class="link" style="text-decoration: none;">Tooth Extraction</a>
                    </p>
                  </div>
                  ...
                  <div class="col-md-3 col-sm-6 col-lg-2 col-xl-2 mx-auto mt-3">
                    ...
                    <p>
                      <a href="index.php#menu" class="link" style="text-decoration: none;">Home</a>
                    </p>
                    <p>
                      <a href="index.php#service" class="link" style="text-decoration: none;">Services</a>
                    </p>
                    <p>
                      <a href="index.php#doctor" class="link" style="text-decoration: none;">Doctors</a>
                    </p>
                    <p>
                      <a href="index.php#location" class="link" style="text-decoration: none;">Locations</a>
                    </p>
                    <p>
          ...
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="form-group row">
                <div class="">
                    <label class="mb-3" for="">You must log in to access admin page.</label>
                  </div>
                  <div class="">
