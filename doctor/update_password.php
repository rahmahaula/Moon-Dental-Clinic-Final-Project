...
$query = "SELECT * FROM doctortable WHERE username='$username'";
...
if (isset($_POST['old_password']) && isset($_POST['new_password']) && isset($_POST['confirm_password'])) {
    ...
    if (password_verify($old_password, $doctor['doctorpassword'])) {
        // Cek apakah password baru sama dengan konfirmasi
        if ($new_password === $confirm_password) {
            $hashed_password = password_hash($new_password, PASSWORD_DEFAULT);
            // Update password di database
            $update_query = "UPDATE doctortable SET doctorpassword='$hashed_password' WHERE username='$username'";
